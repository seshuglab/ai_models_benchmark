...
LANGUAGES = {
    "ru": {
        ...
        "estimated_cost": "Расчётная стоимость",
        "agent_steps": "Шагов агента",
        "run_status": "Статус запуска",
        "metrics_heading": "Метрики",
        "run_error_tool": "Инструмент",
        "run_error_provider": "Провайдер",
        "run_error_opencode": "OpenCode",
        "run_error_process": "Процесс",
        "run_error_run": "Запуск",
    ...
    "en": {
        ...
        "run_error_tool": "Tool",
        "run_error_provider": "Provider",
        "run_error_opencode": "OpenCode",
        "run_error_process": "Process",
        "run_error_run": "Run",
